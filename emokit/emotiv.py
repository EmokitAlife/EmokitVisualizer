...
class Emotiv(object):
    ...
    def __init__(self, display_output=False, serial_number=None, is_research=False, write=False,
        ...
        :param not_connecting_headset - Check if we're detecting a headset connected
        ...
        self.crypto = None
        # Set if we know if it's connected the dongle as false
        self.not_connecting_headset = False
        ...
        while self.running:
            ...
            if tick_diff >= 1:
                ...
                if restarting_reader and self.reader.stopped:
                    self.not_connecting_headset = True
