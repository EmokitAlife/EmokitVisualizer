...
if platform.system() == "Windows":
    pass
from python.emokit.emotiv import Emotiv
...
class PygameDisplay(wx.Window):
    def __init__(self, parent, ID):
        ...
        self.screen.fill((255, 27, 27))


class CalcFrame(demo.mainFrame):

    def __init__(self, parent):
        demo.mainFrame.__init__(self, parent)
        self.display = PygameDisplay(self.rightPanel, -1)
