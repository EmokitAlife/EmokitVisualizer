...
This is an Open Source signal visualizer project for the Emotiv EPOC+ Dongle
...
l´{p{We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/your/project/tags).
